/**
 * Wage Advance Success Modal
 * Shows schedule ID and transaction ID with HashScan links after successful wage advance request
 */

interface WageAdvanceSuccessModalProps {
  result: {
    requestId: string;
    scheduleId: string;
...
export default function WageAdvanceSuccessModal({
  result,
  onClose,
}: WageAdvanceSuccessModalProps) {
      ...
      <div className="bg-gradient-to-br from-green-900/40 to-background-dark border border-green-500/30 rounded-xl max-w-2xl w-full shadow-2xl">
        ...
        <div className="border-b border-green-500/30 p-6 bg-green-500/10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Request Submitted Successfully!</h2>
              <p className="text-green-300 text-sm mt-1">
                Your wage advance request for {formatAmount(result.amount)} WAT has been scheduled
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-background-light/10 border border-purple-700/50 rounded-lg p-4">
            ...
            <p className="text-xs text-gray-400 mt-2">
              This scheduled transaction will be executed once approved by deciders
            </p>
          </div>
          ...
          <div className="bg-background-light/10 border border-blue-700/50 rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-300">Schedule Creation Transaction</span>
              </div>
              <a
